        ...
        */
        ...
        if (sayi<=1){
            ...
            while (fibonacchi.get(i)<sayi){
                ...
                i++; // bir basamak ilerlesin diye i++ yazdik
            }
            if (fibonacchi.get(fibonacchi.size()-1)>sayi){ // fibonacchide yer almiyorsa
                fibonacchi.remove(fibonacchi.size()-1); // son elemani sil

                System.out.println("Girdiginiz sayi fibhonacchide yer almiyor. Girilen sayiya kadarki fibhonacchi "+fibonacchi);

            }else{
                System.out.println("Girdiginiz sayi bir fibhonacchi sayisidir. "+ fibonacchi);
            }
